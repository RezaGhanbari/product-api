...
func TestUpdateProduct(t *testing.T) {
	...
	if m["name"] != originalProduct["name"] {
		t.Errorf("Expected the name to remain the (%v). Got %v", originalProduct["name"], m["name"])
	}

	if m["price"] != originalProduct["price"] {
		t.Errorf("Expected the price to remain the (%v). Got %v", originalProduct["price"], m["price"])
	}
}
